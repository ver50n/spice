...
<html lang="{{ App::getLocale() }}">
  <head>
    ...
    @yield('title')
    @include('layouts.includes.member.asset')
    
    @include('layouts.includes.member.header')
  </head>

  <body>
    <div id="app" class="global-wrapper">
      @include('layouts.includes.member.navbar')
      ...
      <div class="container-fluid">
        ...
        @endif
        @yield('content')
        @include('layouts.includes.member.footer')
      </div>
    </div>
  </body>
  @yield('modal')
