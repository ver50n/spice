...
@section('content')
  <h4>@lang('common.expense') - @lang('common.view')</h4>
      ...
      <div class="card-body">
        <table class="table table-bordered table-striped table-hover table-condensed">
          <tbody>
            ...
            <tr>
              <th><label>@lang('validation.attributes.expense_cd')</label></th>
              <td><label>{{$obj->expense_cd}}</label></td>
            </tr>
            <tr>
            ...
            <tr>
              <th><label>@lang('validation.attributes.expense_category')</label></th>
              <td><label>@lang('application-constant.EXPENSE_CATEGORY.'.App\Helpers\ApplicationConstant::EXPENSE_CATEGORY[$obj->expense_category])</label></td>
            </tr>
            <tr>
              <th><label>@lang('validation.attributes.expense_name')</label></th>
              <td><label>{{$obj->expense_name}}</label></td>
            </tr>
            <tr>
              <th><label>@lang('validation.attributes.expense_amount')</label></th>
              <td><label>{{\App\Utils\NumberUtil::currencyFormat($obj->expense_amount)}}</label></td>
            </tr>
            <tr>
              <th><label>@lang('validation.attributes.expense_at')</label></th>
              <td><label>{{$obj->expense_at}}</label></td>
            </tr>
            <tr>
    ...
    <div id="collapse-view__status-info" class="collapse show">
      <div class="card-body">
        <table class="table table-bordered table-striped table-hover table-condensed">
          <tbody>
            <tr>
              <th><label>@lang('validation.attributes.expense_status')</label></th>
              <td><label>@lang('application-constant.EXPENSE_STATUS.'.App\Helpers\ApplicationConstant::EXPENSE_STATUS[$obj->expense_status])</label></td>
            </tr>
            <tr>
...
@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.expense') .' - '. \Lang::get('common.view')])
@endsection