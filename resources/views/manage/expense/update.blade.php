...
@section('content')
  <h4>@lang('common.expense') - @lang('common.update')</h4>
  ...
  <section class="card components__card-section-wrapper">
    ...
    <div id="collapse-view__base-info" class="collapse show">
      <div class="card-body">
        @include('manage.expense._update-form')
      </div>
    </div>
  </section>
...
@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.expense') .' - '. \Lang::get('common.update')])
@endsection