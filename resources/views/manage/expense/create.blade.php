...
@section('content')
  <h4>@lang('common.expense') - @lang('common.create')</h4>
  ...
  <section class="card components__card-section-wrapper">
    ...
    <div id="collapse-view__base-info" class="collapse show">
      <div class="card-body">
        @include('manage.expense._create-form')
      </div>
    </div>
  </section>
@endsection
...
@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.expense') .' - '. \Lang::get('common.create')])
@endsection