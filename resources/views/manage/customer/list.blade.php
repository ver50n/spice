...
<div class="container-wrapper">
  <div class="subcontainer customer">
    <div class="content-wrapper">
      <h4>@lang('common.customer') - @lang('common.list')</h4>
      ...
      <div class="grid-action-wrapper">
        ...
        <div class="grid-action">
          @include('components.table.grid-export',['model' => 'Customer'])
        </div>
      </div>
...
@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.customer') .' - '. \Lang::get('common.list')])
@endsection
