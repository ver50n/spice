...
@section('content')
  <h4>@lang('common.branch') - @lang('common.view')</h4>
      ...
      <div class="card-body">
        <table class="table table-bordered table-striped table-hover table-condensed">
          <tbody>
            ...
            <tr>
              <th><label>@lang('validation.attributes.operation_day')</label></th>
              <td><label>{{$obj->operation_day}}</label></td>
            </tr>
            <tr>
              <th><label>@lang('validation.attributes.operation_start_time')</label></th>
              <td><label>{{$obj->operation_start_time}} - {{$obj->operation_end_time}}</label></td>
            </tr>
            <tr>
              <th><label>@lang('validation.attributes.map_url')</label></th>
              <td><label><a href="{{$obj->map_url}}" target="_blank">Map</a></label></td>
            </tr>
            <tr>
              <th><label>@lang('validation.attributes.announcement')</label></th>
              <td><label>{!! nl2br($obj->announcement) !!}</label></td>
            </tr>
            <tr>
...
@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.branch') .' - '. \Lang::get('common.view')])
@endsection