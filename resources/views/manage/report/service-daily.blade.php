...
@section('content')
<h4>@lang('common.report') @lang('common.service-daily')</h4>
<div class="container-wrapper">
  <div class="subcontainer report-service-daily">
    <section class="card components__card-section-wrapper no-print">
      ...
      <div class="card-body">
        <form action="{{route($routePrefix.'.service-daily')}}" method="GET">
          ...
          <div>
            <a href="{{route($routePrefix.'.service-daily')}}">
    ...
    @include('pdf-layout.service-daily', ['obj' => $obj])
  </div>
</div>
@endsection

@section('title')
  @include('layouts.includes.title', ['title' => \Lang::get('common.report')." ".\Lang::get('common.service-daily')])
@endsection
