<?php
  ...
  $controller = 'Manage\SubscriptionController';
  ...
  Route::post('/{id}/delete', $controller.'@delete')
    ->name($module.'.delete')
    ->middleware([]);
  Route::post('/{id}/delete-subscription-item', $controller.'@deleteSubscriptionItemPost')
    ->name($module.'.deleteSubscriptionItemPost')
    ->middleware([]);
  Route::post('/{id}/update-subscription-item', $controller.'@updateSubscriptionItemPost')
    ->name($module.'.updateSubscriptionItemPost')
    ->middleware([]);