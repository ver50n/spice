<?php
  $module = 'manage.sale';
  $controller = 'Manage\SaleController';
  ...
  Route::post('/{id}/delete', $controller.'@delete')
    ->name($module.'.delete')
    ->middleware([]);
  Route::post('/{id}/delete-sale-item', $controller.'@deleteSaleItemPost')
    ->name($module.'.deleteSaleItemPost')
    ->middleware([]);
  Route::post('/{id}/update-sale-item', $controller.'@updateSaleItemPost')
    ->name($module.'.updateSaleItemPost')
    ->middleware([]);