...
{
  public $routePrefix = 'manage.bankAccount';
  public $viewPrefix = 'manage.bankAccount';
  public $module = 'bank-account';
  ...
  {
    $obj = BankAccount::findOrFail($request->id);
