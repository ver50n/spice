...
use App\Models\ExpenseVariant;

class ExpenseController extends Controller
{
  public $routePrefix = 'manage.expense';
  public $viewPrefix = 'manage.expense';
  ...
  {
    $obj = Expense::findOrFail($request->id);
